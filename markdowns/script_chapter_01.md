...
Berdasarkan permasalahan tersebut, penelitian ini mengusulkan perancangan dan implementasi sebuah sistem *audio-reactive lighting design* bernama ZZLIGHT-Luxora yang menerima *input* berupa *file* audio lagu rohani (.mp3/.wav), melakukan ekstraksi fitur audio menggunakan teknik *Digital Signal Processing* (DSP), memetakan fitur-fitur tersebut ke parameter pencahayaan RGBW melalui model matematis berbasis ruang warna HSV, dan menghasilkan *scene* serta *chase* pencahayaan secara otomatis. Data pencahayaan tersebut kemudian dikirimkan melalui protokol *Art-Net* ke perangkat lunak QLC+ melalui *virtual adapter*, atau langsung ke modul penerima *Art-Net* berbasis ESP32 yang terhubung melalui jaringan WiFi/*hotspot* ke lampu PAR LED RGBW melalui konverter MAX485 dan kabel DMX. Sistem ini dirancang khusus untuk penggunaan di lingkungan ibadah gereja dengan mempertimbangkan kemudahan pengoperasian bagi pengguna awam.
...
1. Bagaimana merancang dan membangun sistem *audio-reactive lighting design* yang mampu mengekstraksi fitur audio lagu rohani dan memetakannya ke parameter pencahayaan RGBW secara otomatis menggunakan pendekatan *rule-based audio feature mapping* berbasis model matematis HSV?
2. Bagaimana mengintegrasikan *output* pencahayaan dari aplikasi ZZLIGHT-Luxora ke perangkat lampu PAR LED RGBW melalui protokol *Art-Net* DMX512 menggunakan modul ESP32 dan jaringan nirkabel?
...
1. Merancang dan mengimplementasikan aplikasi ZZLIGHT-Luxora yang mampu menghasilkan *scene* dan *chase* pencahayaan RGBW secara otomatis berdasarkan ekstraksi fitur audio lagu rohani menggunakan pemetaan *rule-based* berbasis model matematis HSV.
2. Mengintegrasikan aplikasi dengan protokol *Art-Net* DMX512 dan perangkat lunak QLC+ untuk pengendalian lampu PAR LED RGBW melalui modul ESP32 pada jaringan nirkabel.
